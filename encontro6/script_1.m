...
% Objetivo da aula: Análise de Dados na Plataforma de Força (Salto)
% Objetivo do meu script:
%     1. Carregar arquivo
%     2. Filtrar o dados
%     3. Normalizar pelo tempo
%     4. Calcular a força máxima de propulsao no solo
...
%   Ploting FPRS
    ...
    title({'Força máxima de propulsão';[num2str(round(max_force,2)),' B/W']})

%   Dado resultado 
    result_forca(:,i) = VectNorm;
    
%   Pause para ver o gráfico
%     pause(1)
...
% Calculando o máximo de cada coluna
